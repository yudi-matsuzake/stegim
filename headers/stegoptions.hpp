...
#define STEGIM_STEG_OPTIONS {0,0,0,0,"Command "STEG_NAME,0}, STEGIM_DEFAULT_OPTION, FOREACH_IT_OPT

//INFO
#define INFO_NAME "info"
#define STEGIM_INFO_OPTIONS {0,0,0,0,"Command "INFO_NAME,0}, STEGIM_DEFAULT_OPTION
...
//STEGIM
#define STEGIM_OPTIONS VERBOSE_OPT, QUIET_OPT, STEGIM_STEG_OPTIONS, STEGIM_INFO_OPTIONS, STEGIM_X_OPTIONS
